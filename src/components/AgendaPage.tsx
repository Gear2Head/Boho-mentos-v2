...
const buildExamFromParsed = (entryId: string, p: NonNullable<AgendaEntry['parsedExam']>): ExamResult => {
  return {
    id: `agenda_${entryId}`,
...
function validateAgendaAiPayload(value: unknown): {
  ...
  return {
    summary: isNonEmptyString(value.summary) ? sanitizeAiText(value.summary, 400) : undefined,
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 h-[650px] sticky top-6">
          <InteractiveCalendar />
        </div>
      </div>
    </div>
