  ...
  return (
    <>
          ...
          <motion.div
            ...
            className="w-full max-w-5xl mx-auto my-4 md:my-8 bg-zinc-950/95 backdrop-blur-2xl md:bg-[#FDFBF7] dark:md:bg-zinc-950 border border-white/10 md:border-[#EAE6DF] dark:md:border-zinc-800 shadow-2xl shadow-[#C17767]/10 flex flex-col rounded-[2.5rem] min-h-[calc(100dvh-7rem)] md:min-h-[82vh] overflow-hidden relative"
          >
            <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_20%_0%,rgba(193,119,103,0.14),transparent_32%),radial-gradient(circle_at_90%_20%,rgba(224,159,62,0.10),transparent_30%)]" />
            {isMobile && <div className="w-12 h-1.5 bg-white/20 rounded-full mx-auto mt-4 mb-2 shrink-0 max-md:block hidden" />}
            {/* Header */}
            <div className="p-6 border-b border-[#EAE6DF] dark:border-zinc-800 flex items-center justify-between relative z-10">
            ...
            {/* Content */}
            <div className="flex-1 overflow-y-auto p-5 md:p-8 space-y-8 no-scrollbar relative z-10">
              {/* Lofi Player */}
              {isLofiEnabled && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="rounded-2xl border border-[#C17767]/20 bg-[#C17767]/10 p-4">
                  <p className="text-[9px] uppercase tracking-widest text-[#C17767] font-black">Bugun Odak</p>
                  <p className="text-2xl font-black italic dark:text-zinc-100 mt-1">{Math.floor(dailyFocusSeconds / 3600)}sa {Math.floor((dailyFocusSeconds % 3600) / 60)}dk</p>
                </div>
                <div className="rounded-2xl border border-amber-500/20 bg-amber-500/10 p-4">
                  <p className="text-[9px] uppercase tracking-widest text-amber-500 font-black">Hedef</p>
                  <p className="text-2xl font-black italic dark:text-zinc-100 mt-1">%{Math.round(focusProgress)}</p>
                </div>
                <div className="rounded-2xl border border-zinc-700/40 bg-zinc-900/40 p-4">
                  <p className="text-[9px] uppercase tracking-widest text-zinc-500 font-black">Kesinti</p>
                  <p className="text-2xl font-black italic dark:text-zinc-100 mt-1">{pauseCount}</p>
                </div>
              </div>
              ...
              {/* FLAP TIMER */}
              <div className="flex justify-center gap-2 md:gap-4 py-4 md:py-8">
