...
export function SocialPage() {
  ...
  useEffect(() => {
    ...
    const q = query(collection(db, 'publicProfiles'), orderBy('eloScore', 'desc'), limit(20));
    const unsub = onSnapshot(q, (snap) => {
      const data = snap.docs.map(doc => {
        ...
        return {
          ...
          targetUniversity: d.targetUniversity || d.profile?.targetUniversity,
          targetProgram: d.targetProgram || d.profile?.targetProgram,
        } as WarriorProfile;
