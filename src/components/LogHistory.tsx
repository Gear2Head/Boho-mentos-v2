  ...
  return (
    <div className="bg-[#FFFFFF] dark:bg-zinc-900 border border-[#EAE6DF] dark:border-zinc-800 rounded-xl p-6">
      ...
      {filteredLogs.length === 0 ? (
        ...
        <div ref={parentRef} className="max-h-[500px] overflow-y-auto w-full custom-scrollbar relative pr-2">
          <div
            style={{
              ...
              return (
                ...
                >
                  <button 
                    ...
                    className="w-full text-left p-4 border border-[#EAE6DF] dark:border-zinc-800 rounded-xl bg-[#F5F2EB] dark:bg-zinc-950 hover:border-[#C17767]/50 transition-all active:scale-[0.99] h-full"
                  >
