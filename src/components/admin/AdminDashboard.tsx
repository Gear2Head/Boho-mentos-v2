      ...
      <div className="bg-[#111] border border-zinc-800/60 rounded-3xl p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
          <div className="p-4 bg-zinc-900/30 border border-zinc-800/40 rounded-2xl flex items-center justify-between gap-4">
            ...
            <button disabled className="px-4 py-2 bg-zinc-800 text-zinc-500 rounded-lg text-[10px] font-bold uppercase cursor-not-allowed opacity-60">Devre disi</button>
          </div>
          <div className="p-4 bg-red-950/10 border border-red-900/20 rounded-2xl flex items-center justify-between gap-4">
            ...
            <button disabled className="px-4 py-2 bg-red-900/40 text-red-300 rounded-lg text-[10px] font-bold uppercase cursor-not-allowed opacity-60">Devre disi</button>
          </div>
        </div>
      </div>
    </div>
