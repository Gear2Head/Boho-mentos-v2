  ...
  setProfile: (profile) => {
    ...
    if (authUser?.uid && profile) {
      ...
      publishPublicProfileProjection({
        ...
        profile,
        eloScore: get().eloScore,
        streakDays: get().streakDays,
        focusSessions: get().focusSessions,
        trophies: get().trophies,
        tytSubjects: stateUpdates.tytSubjects ?? get().tytSubjects,
        aytSubjects: stateUpdates.aytSubjects ?? get().aytSubjects,
  ...
  recomputeStreak: (consumeShields = true) => {
    ...
    if (authUser?.uid) {
      ...
      publishPublicProfileProjection({
        ...
        focusSessions: get().focusSessions,
        trophies: get().trophies,
        tytSubjects: get().tytSubjects,
        aytSubjects: get().aytSubjects,
        inventory: get().inventory,
      }).catch(console.error);
    }
